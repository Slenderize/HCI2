                                ...
                                content={
                                    <div>
                                        <div className="typo-line">
                                            <h1><p className="category">Header 1</p>Financial Aid Center</h1>
                                        </div>

                                        <div className="typo-line">
                                            <h2><p className="category">Header 2</p>Financial Aid Center</h2>
                                        </div>
                                        <div className="typo-line">
                                            <h3><p className="category">Header 3</p>Financial Aid Center</h3>
                                        </div>
                                        <div className="typo-line">
                                            <h4><p className="category">Header 4</p>Financial Aid Center</h4>
                                        </div>
                                        <div className="typo-line">
                                            <h5><p className="category">Header 5</p>Financial Aid Center</h5>
                                        </div>
                                         <div className="typo-line">
                                            <h6><p className="category">Header 6</p>Financial Aid Center</h6>
                                        </div>
                                        <div className="typo-line">
