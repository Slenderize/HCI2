                                ...
                                content={
                                    <div>
                                        <div className="typo-line">
                                            <h1><p className="category">Header 1</p>Enrollment</h1>
                                        </div>

                                        <div className="typo-line">
                                            <h2><p className="category">Header 2</p>Enrollment</h2>
                                        </div>
                                        <div className="typo-line">
                                            <h3><p className="category">Header 3</p>Enrollment</h3>
                                        </div>
                                        <div className="typo-line">
                                            <h4><p className="category">Header 4</p>Enrollment</h4>
                                        </div>
                                        <div className="typo-line">
                                            <h5><p className="category">Header 5</p>Enrollment</h5>
                                        </div>
                                         <div className="typo-line">
                                            <h6><p className="category">Header 6</p>Enrollment</h6>
                                        </div>
                                        <div className="typo-line">
